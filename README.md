...
```sh
git clone https://github.com/foo/test_app.git
cd test_app
...
```sh
pip install dist/test_app-0.1.0
```
...
| Name | E-mail     |
|------|------------|
| AG | [amir.golparvar@physik.hu-berlin.de](mailto:amir.golparvar@physik.hu-berlin.de)
